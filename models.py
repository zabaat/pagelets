...
class Pagelet(PageletBase):
    ...
    css_parent = models.CharField(
        _('Parent CSS classes'),
        max_length=255,
        blank=True,
        null=True,
        help_text=_('Extra CSS classes, if any, to be added to the pikatainer DIV '
                    'in the HTML.'),
    )
    ...
    content = RichTextField(_('content'), config_name='adv',blank=True)
